...
class FabricDeployer:
    ...
    def deploy(self):
        # 1. Create Lakehouse 
        self.create_lakehouse("UC02_LeastPrivilegeScoring_Lakehouse")
        ...
        for file_path in sorted(notebook_files):
            ...
            # And handling the UC02 prefix logic
            ...
            display_name = f"UC02_{display_name_stem}"
        ...
        if notebook_ids:
            ...
            self.create_pipeline("UC02_Automated_Pipeline", notebook_ids)
            
            # 4. Run Pipeline
            self.run_pipeline("UC02_Automated_Pipeline")
        else:
